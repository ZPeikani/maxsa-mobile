    ...
    <Box>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            >
              ...
              >
                ...
                <Typography fontSize="15px" fontWeight="light" color="#717171" width="133px" textAlign="center">
                  Chaharbagh Street, Isfahan,IRAN
                </Typography>
              </CardContent>
            </Card>
          </Grid>
      ...
      <Box display="flex" gap={10} justifyContent="center">
        <Box width="470px">
          ...
          <Typography fontSize="20px" fontWeight="light" color="#717171" textAlign="justify">
