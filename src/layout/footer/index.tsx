...
import OnlineChat from "../../assets/icons/online chat.svg";
import BackToUp from "../../assets/icons/back to up bottun.svg";
...
export default function Footer() {
  return (
    <Box>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" sx={{backgroundColor:"#021736",fontWeight: "lighter",paddingY:"5px"}} color="#CBCBCB" >
        <Typography fontSize="12px" display="flex" justifyContent="center" alignItems="center" gap="6px"><span style={{ fontSize: "2rem" }}>©</span>{new Date().getFullYear()} Tech Heim.</Typography>
